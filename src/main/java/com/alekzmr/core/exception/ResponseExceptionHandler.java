package com.alekzmr.core.exception;
...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public final ResponseEntity<ExceptionResponse> manageAllException(ModelNotFoundException ex, WebRequest req){
	...
	@ExceptionHandler
	public final ResponseEntity<ExceptionResponse> manageNotFoundException(ModelNotFoundException ex, WebRequest req){
		ExceptionResponse er = new ExceptionResponse(LocalDateTime.now(), ex.getMessage(), req.getDescription(false));
